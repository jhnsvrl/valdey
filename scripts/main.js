'';(function (window) {
  ...
  let texts = ['TRY TO CLICK ME :D','WOW, LOOK AT THE SKY BEHIND US','IT LOOKED SUPER GORGEOUS ISNT IT?','WELL, SINCE U LOOK SUPER GORGEOUS','I WANT TO SAY SOMETHING FOR U','TO THE LOVE OF MY LIFE', 'TO MY SOULMATE','MY PRINCESS <3', ' YOU ARE MY HAPPINESS','YOU ARE THE REASON WHY I SMILE','YOU ARE MY LAUGHTER',' YOU ARE MY JOY','YOU ARE MY LOVE','YOU MEANT THE WORLD TO ME','YOU ARE MY EVERYTHING','I LOVE U SO MUCHH <3','HAPPY VALENTINES DAYY! <3','BYEE SEE U NEXT TIMEE !!']
  ...
  class Particle {
    ...
    draw (ctx) {
      ctx.fillStyle = 'rgba(255,122,223, ' + this.opacity + ')'
      ctx.beginPath()
